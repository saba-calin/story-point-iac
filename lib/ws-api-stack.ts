...
export class WsApiStack extends cdk.Stack {
  constructor(
    ...
    const wsCreateStoryLambdaIntegration = new apigwv2Integrations.WebSocketLambdaIntegration('WsCreateStoryLambdaIntegration', lambda.Function.fromFunctionName(this, 'WsCreateStoryLambda', 'ws-create-story_lambda'));
    wsApi.addRoute("create-story", {
    ...
    const wsRevoteLambdaIntegration = new apigwv2Integrations.WebSocketLambdaIntegration('WsRevoteLambdaIntegration', lambda.Function.fromFunctionName(this, 'WsRevoteLambda', 'ws-revote_lambda'));
    wsApi.addRoute("revote", {
      integration: wsRevoteLambdaIntegration
    });
